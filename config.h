...
static const char *fonts[]                    = { "DejaVu Sans Mono:size=11", "NotoColorEmoji:pixelsize=25:antialias=true:autohint=true" };
...
/* commands */
static const char *launchercmd[] = { "rofi", "-show", "drun", "-dpi", "1",  NULL };
